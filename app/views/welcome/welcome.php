...
<body class="landing-body">
  <div class="app">
    ...
    <section class="c-s-landing flex-center flex-column">
      <h1>Nos encontramos remodelando nuestra pagina principal</h1>
      <h2>Tranquilo, aún puedes interactuar con la aplicación iniciando sesión o registrandote</h2>
      <div class="c-buttons d-flex justify-content-evenly">
        <div class="btn-login">
